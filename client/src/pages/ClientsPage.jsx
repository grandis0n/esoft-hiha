...
const ClientsPage = () => {
    ...
    const [sugdemModalActive, setSugDemModalActive] = useState(false);
    ...
    function openSugDemModal(id){
      setSugDemModalActive(true)
    ...
    return(
        <div className="clients__container">
          ...
          {isClientsLoading || !clients
              ? <h1>Идет загрузка</h1>
              : <ClientList clients={clients??[]} openModal={openModal} openEditModal={openEditModal} openSugDemModal={openSugDemModal}/>
          }
        </div>
    );
};
